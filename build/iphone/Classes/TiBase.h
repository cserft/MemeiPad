...
// in simulator we redefine to format for MemeiPad Developer console
...
{\
	NSString * exceptionName = [@"org.memeipad." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.memeipad";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMemeiPadNativeItemNone = -1, 
	UIMemeiPadNativeItemSpinner = -2,
	UIMemeiPadNativeItemProgressBar = -3,
	
	UIMemeiPadNativeItemSlider = -4,
	UIMemeiPadNativeItemSwitch = -5,
	UIMemeiPadNativeItemMultiButton = -6,
	UIMemeiPadNativeItemSegmented = -7,
	
	UIMemeiPadNativeItemTextView = -8,
	UIMemeiPadNativeItemTextField = -9,
	UIMemeiPadNativeItemSearchBar = -10,
	
	UIMemeiPadNativeItemPicker = -11,
	UIMemeiPadNativeItemDatePicker = -12,
	
	UIMemeiPadNativeItemInfoLight = -13,
	UIMemeiPadNativeItemInfoDark = -14,
	
	UIMemeiPadNativeItemDisclosure = -15,
	
	UIMemeiPadNativeItemContactAdd = -16
};
