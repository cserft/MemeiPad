...
NSString * const TI_APPLICATION_ID = @"R8AP6NQLDE.com.yahoo.meme.ipad";
NSString * const TI_APPLICATION_PUBLISHER = @"Yahoo! Inc.";
NSString * const TI_APPLICATION_URL = @"http://me.me/ipad";
...
NSString * const TI_APPLICATION_COPYRIGHT = @"2011 Yahoo! Inc.";
